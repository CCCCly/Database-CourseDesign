...
public class DelStu extends JPanel implements ActionListener
{
    ...
    private JLabel jl = new JLabel("输入学号");
    private JTextField jtf = new JTextField();
    private JButton jb = new JButton("删除");
	public DelStu(String host)
	{
		this.host = host;
	    this.initialFrame();	
	}
	...
	public void actionPerformed(ActionEvent e) 
	{
		if(e.getSource()==jb)
		{
			...
			int i = JOptionPane.showConfirmDialog(this, "以下操作将删除该运动员的所有信息");
			if(i==0)
			{
                ...
                try
                {
                    ...
                    {
                    	JOptionPane.showMessageDialog(this,"删除失败,请检查学号是否正确","提示",JOptionPane.INFORMATION_MESSAGE);
                    }
                }
